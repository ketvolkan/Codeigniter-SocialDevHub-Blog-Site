<div class="yazi" style="position: fixed; right: 1%; bottom: 50%; z-index: 4;">
  <div class="email" onclick="this.classList.add('expand')">
    <div class="from">
      <div class="from-contents" style="z-index: 5;">

            <img src="assets/img/dclogo.png"/>
    ...
    <div class="to">
      <div class="to-contents">
        <div class="top">
          ...
          <div class="name-large">Discord'a Katıl!</div>
