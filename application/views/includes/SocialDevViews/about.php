        ...
        <section class="page-section bg-masthead text-white mb-0" id="about">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white"><?php echo $setting->about_title; ?></h2>
                <!-- Icon Divider-->
                ...
                <div class="col-lg-5 mx-auto">
                    <p class="lead text-center"><?php echo $setting->about_description; ?></p>
                </div>
