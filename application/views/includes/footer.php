            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <a class="btn btn-outline-light btn-social mx-1" target="blank"
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <a class="btn btn-outline-light btn-social mx-1" target="blank"
                            ...
                            <i class="fa-solid fa-user"></i> <a class="btn btn-outline-light btn-social mx-1"
                                target="blank" href="https://www.instagram.com/ketvlkn/?hl=tr">
                                <i class="fa-solid fa-user"></i> <a class="btn btn-outline-light btn-social mx-1"
                                    target="blank" href="https://www.instagram.com/bbaranozel/?hl=tr">
